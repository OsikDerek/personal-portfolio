...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className="py-16 bg-neutral-100 section-fade"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-1/2">
            <h3 className="text-2xl font-bold font-montserrat text-primary mb-6">
              Project Inquiries
            </h3>
            <p className="text-lg text-neutral-700 mb-8">
              Interested in exploring potential collaborations, innovative
              sports technology projects, or training programs? Reach out to
              discuss consulting services, speaking engagements, or partnership
              opportunities.
            </p>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="bg-white w-12 h-12 flex items-center justify-center rounded-full shadow-md hover:shadow-lg transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
          ...
          <div className="w-full lg:w-1/2">
            <form
              action="https://formspree.io/f/xqaqwjja"
              method="POST"
