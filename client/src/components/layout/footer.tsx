        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-6 md:mb-0">
            <a href="#home" className="flex items-center space-x-2">
              <span className="text-2xl font-bold font-montserrat">DO</span>
              <span className="text-lg font-semibold font-montserrat">
                Derek Osik
              </span>
            </a>
            <p className="text-neutral-400 mt-2 max-w-md">
              Professional hockey player, skating coach, and AI consultant
              bringing a unique perspective to sports performance and
              technology.
            </p>
          </div>
